...
These docs are a great place to start. We've broken down the guides into sections based on where you are in your journey using Kumu. If you're just getting started, make sure to watch the [five-minute quickstart video](../getting-started/five-minute-quickstart.md). Already an expert but looking for some advanced tips? Use the search in the upper left or jump to the [advanced guides](../advanced-guides/advanced-settings.md).
