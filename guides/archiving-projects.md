...
To archive one of your projects: open the project, then click the menu icon ![](../.gitbook/assets/bars.svg) in the upper left corner to open the [project settings](../overview/settings.md#project-settings). Select **Admin**, and click **Archive project**.

![Admin settings](../.gitbook/assets/admin-settings.png)

{% hint style="info" %}
Project archiving is an exclusive feature for [Pro workspaces](pro-workspaces.md).
{% endhint %}
