...
<table class="table table-striped"><tbody>
        ...
        <tr>
            <td>Diameter</td>
            <td>The shortest path between the two elements that are furthest apart in a network. If any of your elements have no connections, the diameter will be infinity ∞.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Calculates the average number of steps it takes to get from one element to another in the network. If any of your elements have no connections, the average path length will be infinity ∞.</td>
        </tr>
</tbody></table>
