...
To know when focus is turned on, look for a blue target icon ![](../.gitbook/assets/crosshairs.svg) on the right side of the map. If it's blue, click it to turn focus off, or just press `Esc` on your keyboard.
...
![Unhide Elements](../.gitbook/assets/unhide-elements.png)

## Did your Google Sheet disconnect?

If you imported your data through Google Sheets, then that link is the lifeline to the data in your map. If your sheet link is disconnected or deleted, then all the data in your map will disappear. Click on the green ![](../.gitbook/assets/plus-circle.svg) button at the bottom and choose Import, or hit the "i" key of your keyboard to see whether your Google Sheet is still connected.
