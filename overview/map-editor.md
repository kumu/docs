...
* ![](../icons/comment.svg) The chat bubble opens up [Discussions](../guides/issues.md), where you can chat with your team and attach comments to the map
...
* ![](../icons/comments.svg) [Attach a comment](../guides/issues.md) to your selected item
